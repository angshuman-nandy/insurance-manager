...
Detail.create(email: u1.email, first_name: 'admin', last_name: 'admin', admin: 1, contact_number: 4893823429, address: 'some address',user_id: u1.id)
u2=User.create(email: 'user@gmail.com',password: 'password',password_confirmation: 'password')
Detail.create(email: u2.email, first_name: 'user', last_name: 'user', admin: 0, contact_number: 1233453429, address: 'some differernt address',user_id: u2.id)
